...
final class Version20250216202635 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'CREATE TABLE origine_bonus (base_bonus_id INT NOT NULL, territoire_id INT NOT NULL, INDEX IDX_BE69354723BFF59E (base_bonus_id), INDEX IDX_BE693547D0F97A8 (territoire_id), PRIMARY KEY(base_bonus_id, territoire_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB'
        );
        $this->addSql(
        ...
        $this->addSql(
            'ALTER TABLE origine_bonus ADD CONSTRAINT FK_BE69354723BFF59E FOREIGN KEY (base_bonus_id) REFERENCES bonus (id) ON DELETE CASCADE'
        );
        $this->addSql(
