...
enum CompetenceFamilyType: string
{
    ...
    public static function tryFromOlder(string $value): ?CompetenceFamilyType
    {
        return match ($value) {
            ...
            'Armes Ã  distance', 'Armes à distance', "Armes Ã\u{A0} à distance", "Armes Ã\u{A0} distance" => self::RANGED_WEAPONS,
            'Armure' => self::ARMOR,
            ...
            'Forge', 'Armurerie' => self::FORGE,
            'GuÃ©rison', 'Guérison' => self::HEALING,
            'Herboristerie' => self::HERBALISM,
