...
class ObjetType extends AbstractType
{
    ...
    {
        $builder
            ->add('nom', \Symfony\Component\Form\Extension\Core\Type\TextType::class, ['required' => true])
            ...
            ->add('proprietaire', \Symfony\Bridge\Doctrine\Form\Type\EntityType::class, [
                'required' => false,
                'class' => \App\Entity\Proprietaire::class,
                'choice_label' => 'nom',
            ])
            ...
            ->add('rangement', \Symfony\Bridge\Doctrine\Form\Type\EntityType::class, [
                'required' => false,
                'class' => \App\Entity\Rangement::class,
                'choice_label' => 'adresse',
            ])
            ->add('etat', \Symfony\Bridge\Doctrine\Form\Type\EntityType::class, [
                'required' => false,
                'class' => \App\Entity\Etat::class,
                'choice_label' => 'label',
            ])
            ...
            ->add('investissement', \Symfony\Component\Form\Extension\Core\Type\ChoiceType::class, ['choices' => [
                'false' => 'usage unique',
                'true' => 'ré-utilisable',
            ]]);
    }
