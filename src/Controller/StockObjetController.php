...
{	
	...
	{	
		$repoRangement = $app['orm.em']->getRepository('\App\Entity\Rangement');
		$rangements = $repoRangement->findAll();
		
		$repoTag = $app['orm.em']->getRepository('\App\Entity\Tag');
		$tags = $repoTag->findAll();

		$repoObjet = $app['orm.em']->getRepository('\App\Entity\Objet');
	...
	{
		$repo = $app['orm.em']->getRepository('\App\Entity\Objet');
