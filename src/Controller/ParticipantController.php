...
class ParticipantController extends AbstractController
{
    ...
    public function reponseAction(Application $app, Request $request, Participant $participant, Question $question, $reponse)
    {
        ...
        return $app->redirect($app['url_generator']->generate('gn.detail', ['gn' => $participant->getGn()->getId()]), 303);
    }
    ...
    public function newAction(Application $app, Request $request, User $User)
    {
        ...
        if ($form->isValid()) {
            ...
            return $app->redirect($app['url_generator']->generate('User.admin.list', []), 303);
        }
    ...
    public function groupeAction(Application $app, Request $request, Participant $participant)
    {
        ...
        */
        ...
        if ($form->isValid()) {
            ...
            return $app->redirect($app['url_generator']->generate('gn.participants', ['gn' => $participant->getGn()->getId()]), 303);
        }
    ...
    public function politiqueAction(Request $request, Application $app, Participant $participant)
    {
        ...
        if (!$personnage->hasCompetence('Politique')) {
            ...
            return $app->redirect($app['url_generator']->generate('gn.personnage', ['gn' => $participant->getGn()->getId()]), 303);
        }
    ...
    public function personnageOldAction(Request $request, Application $app, Participant $participant)
    {
        ...
        if (!$participant->getBillet()) {
            ...
            return $app->redirect($app['url_generator']->generate('gn.detail', ['gn' => $groupeGn->getGn()->getId()]), 303);
        }
    ...
    public function adminPersonnageOldAction(Request $request, Application $app, Participant $participant)
    {
        ...
        if ($form->isValid()) {
            ...
            return $app->redirect($app['url_generator']->generate('gn.participants.withoutperso', ['gn' => $gn->getId()]), 303);
        }
    ...
    public function adminPersonnageNewAction(Request $request, Application $app)
    {
        ...
        if ($form->isValid()) {
            ...
            return $app->redirect($app['url_generator']->generate('gn.participants.withoutperso', ['gn' => $groupeGn->getGn()->getId()]), 303);
        }
    ...
    public function personnageSecondaireAction(Request $request, Application $app, Participant $participant)
    {
        ...
        if ($form->isValid()) {
            ...
            return $app->redirect($app['url_generator']->generate('gn.detail', ['gn' => $participant->getGroupeGn()->getGn()->getId()]), 303);
        }
    ...
    public function groupeSecondairePostulerAction(Request $request, Application $app, Participant $participant, SecondaryGroup $groupeSecondaire)
    {
        ...
        if ($form->isValid()) {
            ...
            if (empty($data['explanation'])) {
                ...
                $postulant = new \App\Entity\Postulant();
    ...
    public function groupeSecondaireAcceptAction(Request $request, Application $app, Participant $participant, SecondaryGroup $groupeSecondaire, Postulant $postulant)
    {
        ...
        if ($form->isValid()) {
            ...
            return $app->redirect($app['url_generator']->generate('participant.groupeSecondaire.detail', ['participant' => $participant->getId(), 'groupeSecondaire' => $groupeSecondaire->getId()]), 303);
        }
        ...
        if ($form->isValid()) {
            ...
            if (null != $joueurs) {
                if (0 == $joueurs->count()) {
                    ...
                    return $app->redirect($app['url_generator']->generate('joueur.detail.orga', ['index' => $joueurs->first()->getId()]), 303);
                } else {
