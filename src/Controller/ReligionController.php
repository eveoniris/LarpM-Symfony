...
class ReligionController
{
	...
	public function detailAction(Request $request, Application $app)
	{
		...
		$religion = $app['orm.em']->find('\App\Entity\Religion',$id);
	...
	{
		$repo = $app['orm.em']->getRepository('\App\Entity\ReligionLevel');
	...
	public function levelDetailAction(Request $request, Application $app)
	{
		...
		$religionLevel = $app['orm.em']->find('\App\Entity\ReligionLevel',$id);
