...
{	
	...
	public function listAction(Request $request, Application $app)
	{
		...
		$repo = $app['orm.em']->getRepository('\App\Entity\Background');
	...
	{
	    $gns = $app['orm.em']->getRepository('\App\Entity\Gn')->findActive();
	    if(count($gns)==0)
        {
		...
		$backgrounds = $app['orm.em']->getRepository('\App\Entity\Background')->findBackgrounds($gns[0]->getId());
	...
	public function personnagePrintAction(Request $request, Application $app)
	{
		...
		$groupeGns = $app['orm.em']->getRepository('\App\Entity\GroupeGn')->findByGn($gns[0]->getId());
	...
	public function addAction(Request $request, Application $app)
	{
		...
		if ( $groupeId )
		{
			$groupe = $app['orm.em']->find('\App\Entity\Groupe', $groupeId);
