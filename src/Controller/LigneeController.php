...
class LigneeController extends AbstractController
{
    ...
    public function listAction(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $lignees = $repo->findList($type, $value, $limit, $offset, ['by' => $order_by, 'dir' => $order_dir]);

        $paginator = $repo->findPaginatedQuery($lignees, $this->getRequestLimit(), $this->getRequestPage());
