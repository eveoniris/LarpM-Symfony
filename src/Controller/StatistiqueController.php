...
class StatistiqueController
{
	...
	{
		$repo = $app['orm.em']->getRepository('App\Entity\Langue');
		...
		$repo = $app['orm.em']->getRepository('App\Entity\Construction');
		...
		$repo = $app['orm.em']->getRepository('App\Entity\Competence');
		...
		$repo = $app['orm.em']->getRepository('App\Entity\Genre');
		$genres = $repo->findAll();
		$statGenres = array();
