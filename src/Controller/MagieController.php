...
class MagieController
{
	...
	{
		$spheres = $app['orm.em']->getRepository('\App\Entity\Sphere')->findAll();
	...
	{
		$prieres = $app['orm.em']->getRepository('\App\Entity\Priere')->findAll();
	...
	{
		$potions = $app['orm.em']->getRepository('\App\Entity\Potion')->findAll();
	...
	{
		$sorts = $app['orm.em']->getRepository('\App\Entity\Sort')->findAll();
