...
class LangueController
{
	...
	{
		$langues = $app['orm.em']->getRepository('\App\Entity\Langue')->findAllOrderedByLabel();
		$groupeLangues = $app['orm.em']->getRepository('\App\Entity\GroupeLangue')->findAllOrderedByLabel();
	...
	public function detailAction(Request $request, Application $app)
	{
		...
		$langue = $app['orm.em']->find('\App\Entity\Langue',$id);
	...
	public function detailGroupAction(Request $request, Application $app)
	{
		...
		$groupeLangue = $app['orm.em']->find('\App\Entity\GroupeLangue',$id);
