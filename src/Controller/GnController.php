...
class GnController extends AbstractController
{
    ...
    #[Route('/gn/detail/{id}', name: 'gn.detail')]
     ...
     */
    #[Route('/gn/{id}/personnage', name: 'gn.personnage')]
     ...
     */
    #[Route('/gn/{id}/personnages', name: 'gn.personnages')]
    ...
    #[Route('/gn/update/{id}', name: 'gn.update')]
