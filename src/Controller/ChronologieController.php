...
class ChronologieController
{
	...
	public function apiUpdateAction(Request $request, Application $app)
	{
		...
		$territoire = $app['orm.em']->find('\App\Entity\Territoire',$payload->territoire_id);
	...
	{
		$repo = $app['orm.em']->getRepository('\App\Entity\Chronologie');
	...
	public function addAction(Request $request, Application $app)
	{
		...
		if ( $territoireId )
		{
			$territoire = $app['orm.em']->find('\App\Entity\Territoire', $territoireId);
			if ( $territoire )
			{
	...
	public function updateAction(Request $request, Application $app)
	{
		...
		$chronologie = $app['orm.em']->find('\App\Entity\Chronologie',$id);
		if ( !$chronologie )
		{
			return $app->redirect($app['url_generator']->generate('chronologie'));
		}
