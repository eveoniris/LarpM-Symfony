...
class StrategieRepository extends BaseRepository
{
    ...
    protected function getStrategieQueryBuilder(int $gnId, ?string $type, mixed $value, array $order = []): QueryBuilder
    {
    ...
    public function sortAttributes(?string $alias = null): array
    {
        ...
        return [
            'gn' => [
                OrderBy::DESC => [$alias . '.gn' => OrderBy::ASC],
                OrderBy::ASC => [$alias . '.gn' => OrderBy::DESC],
            ],
            'groupe' => [
            ...
            'player.username' => [
                OrderBy::ASC => ['player.username' => OrderBy::ASC],
                OrderBy::DESC => ['player.username' => OrderBy::DESC],
            ],
        ];
    }
