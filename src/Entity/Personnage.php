...
class Personnage extends BasePersonnage
{
	 ...
	 */
	public function getLastParticipant() : ?\App\Entity\Participant
	{
	 ...
	 * 
	 * @return \App\Entity\Gn|NULL
	 */
	public function getLastParticipantGn() : ?\App\Entity\Gn
	{
	    $lastParticipant = $this->getLastParticipant();
	    if ($lastParticipant)
	    {
	 ...
	 * 
	 * @return \App\Entity\Groupe|NULL
	 */
	public function getLastParticipantGnGroupe() : ?\App\Entity\Groupe
	{
	    $lastParticipant = $this->getLastParticipant();   
	    if ($lastParticipant)
	    {
