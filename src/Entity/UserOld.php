 ...
 */
class UserOld extends BaseUser //implements AdvancedUserInterface, \Serializable
{
	/**
	 ...
	 */
	public function getParticipant(Gn $gn) : ?\App\Entity\Participant
	{
		foreach ( $this->getParticipants() as $participant )
		{
	 ...
	 * @param App\Entity\Post $post
	 */
	public function alreadyView(\App\Entity\Post $post)
	{
	 ...
	 * @param App\Entity\Post $post
	 */
	public function newResponse(\App\Entity\Post $post)
	{
