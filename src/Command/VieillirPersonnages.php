...
#[AsCommand(name: 'app:vieillir-personnages', description: 'Verrouille tout les groupes et joueur')]
class VieillirPersonnages extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($this->personnageService->vieillirTous($input->getArgument('year'), $input->getArgument('dieage'), $input->getArgument('force')) as $result) {
