...
namespace App\TinymceBundle\Util;
...
class TinymceConfigurator
{
    ...
    public function getGlobalAttributes(): array
    {
        if (null === $this->globalAttributes) {
            ...
            $this->globalAttributes = array_filter($attributes, static fn ($value) => '' !== $value);
        }
    ...
    private function processUserConfig(array $config): array
    {
        ...
        unset($config['images_upload_route'], $config['images_upload_route_params']);
